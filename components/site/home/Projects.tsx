    ...
    <section className="py-24 px-6 max-w-7xl mx-auto">
      <div className="mb-20 text-center md:text-left">
        <SplitText
          ...
          tag="h2"
        />
        <p className="text-foreground/70 text-lg max-w-2xl font-light leading-relaxed">
        ...
        {projects.map((project, idx) => (
          ...
          >
            <div className="w-full md:w-1/2">
              <div className="bg-foreground/5 rounded-[2rem] w-full h-[400px] shadow-sm border border-foreground/5 flex items-center justify-center">
